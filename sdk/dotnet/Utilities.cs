...
namespace Katasec.Boundary
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Katasec.Boundary.version.txt");
    ...
    internal sealed class BoundaryResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BoundaryResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
